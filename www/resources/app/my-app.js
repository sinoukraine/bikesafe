...
API_URL.URL_USERGUIDE = 'https://support.bikesafe.co/manual/bikesafe-app.pdf';
API_URL.URL_SUPPORT = "https://support.bikesafe.co/?name={0}&loginName={1}&email={2}&phone={3}&s={4}";
